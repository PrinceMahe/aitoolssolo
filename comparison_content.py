...
# Comparison table content per slug: rows = [feature, tool_val, competitor_val]
# Features: Pricing, Free plan, Best for, Platform, API, Ease of use, Integrations, Overall score
tables = {
...
json.dump(tables, open("comparison_tables.json","w",encoding="utf-8"), ensure_ascii=False, indent=2)
print(f"Prepared {len(tables)} comparison tables")
